...
set_property PACKAGE_PIN W5 [get_ports clk]							
	...
	create_clock -add -name sys_clk_pin -period 10000000000.00 -waveform {0 5} [get_ports clk]
...
set_property PACKAGE_PIN W14 [get_ports { shr_in }]					
	set_property IOSTANDARD LVCMOS33 [get_ports { shr_in }]
set_property PACKAGE_PIN W13 [get_ports { shl_in }]					
